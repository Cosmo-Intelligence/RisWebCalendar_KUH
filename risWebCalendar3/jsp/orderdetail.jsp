...
<%@ page import="com.yokogawa.radiquest.ris.servlet.SimpleDateFormatType"%>
...
<%@ page import="com.yokogawa.radiquest.ris.DBAccess.CodeConvertDataHome"%>
...
<input id="columnCnt" type="hidden" value="<%=orderDetailItems.size()%>">
<input id="tableWidth" type="hidden" value="<%=tableWidth%>">
...
<table>
	<tbody>
		...
		<tr class="status<%= status %>">
			<td style="display: none"><span class="orderDetailRisID" style="display: none;"><%= orderDetail.getRisID() %></span></td>
			<%
			...
			%>
			<td class="orderDetailLine" style="width: <%= odItem.getWidth() %>px;">
			<div style="white-space: nowrap; overflow-x:hidden; width:<%= odItem.getWidth() %>px;">
			<%= tdData %></div>
			</td>
			<%
				}
